...
func TestComputeNextFire_Once(t *testing.T) {
	result := ComputeNextFire("once", map[string]any{}, utc("2025-11-09 10:00"), tzMoscow)
...
func TestComputeNextFire_Daily_SameDay(t *testing.T) {
	...
	got := ComputeNextFire("daily", params, after, tzMoscow)
...
func TestComputeNextFire_Weekly_ThisWeek(t *testing.T) {
	...
	got := ComputeNextFire("weekly", params, after, tzMoscow)
	require.NotNil(t, got)
...
func TestComputeNextFire_Monthly(t *testing.T) {
	...
	got := ComputeNextFire("monthly", params, after, tzMoscow)
	require.NotNil(t, got)
...
func TestComputeNextFire_Yearly(t *testing.T) {
	...
	got := ComputeNextFire("yearly", params, after, tzMoscow)
	require.NotNil(t, got)
...
func TestComputeNextFire_CustomDays(t *testing.T) {
	...
	got := ComputeNextFire("custom_days", params, after, tzMoscow)
	require.NotNil(t, got)
	want := utc("2025-11-09 06:00") // 09:00 Moscow
	assert.Equal(t, want, *got)
}
...
func TestComputeNextFire_UnknownType(t *testing.T) {
	result := ComputeNextFire("unknown_type", map[string]any{}, utc("2025-11-09 10:00"), tzMoscow)
	assert.Nil(t, result)
}
