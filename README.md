...
- **Дерево хранилища** — откройте заметку через папки и нажмите «✏️ Дописать», чтобы добавить текст. После сохранения можно дописать ещё или вернуться в ту же папку.
...
- **Агентный поиск по заметкам** — планирование нескольких hybrid-запросов, навигация по компактным карточкам заметок, раскрытие исходных чанков и проверяемый ответ
